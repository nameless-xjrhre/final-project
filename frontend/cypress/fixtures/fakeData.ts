...
for (let i = 0; i < 100; i++) {
  let object = {
    ...
    appointmentDate: faker.date.future().toLocaleDateString('en-US', {
      month: '2-digit',
      day: '2-digit',
      year: 'numeric',
    }),
    startTime: faker.date.future().toLocaleTimeString('nl', {
      hour: '2-digit',
      hourCycle: 'h24',
      minute: '2-digit',
    }),
    endTime: faker.date.future().toLocaleTimeString('nl', {
      hour: '2-digit',
      hourCycle: 'h24',
      minute: '2-digit',
    }),
