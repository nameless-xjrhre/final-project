describe('Doctors Page - Close A Schedule Test', () => {
  ...
  it('should close a schedule', () => {
    cy.get(
      '[class="MuiButtonBase-root MuiChip-root MuiChip-filled MuiChip-sizeMedium MuiChip-colorDefault MuiChip-clickable MuiChip-clickableColorDefault MuiChip-filledDefault css-j4zylg-MuiButtonBase-root-MuiChip-root"]',
    )
      .last()
      .click()
      .get('[value="CLOSED"]')
