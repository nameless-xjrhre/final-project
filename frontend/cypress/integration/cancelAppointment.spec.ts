...
describe('Dashboard Page - Cancel Appointment Test', () => {
    ...
    it('should cancel appointment', () => {
        cy.get('[class="MuiButton-root MuiButton-text MuiButton-textPrimary MuiButton-sizeMedium MuiButton-textSizeMedium MuiButtonBase-root  css-1e6y48t-MuiButtonBase-root-MuiButton-root"]')
            .wait(5000)
            .its('length')
            .then((len) => {
                cy.get('[class="MuiButton-root MuiButton-text MuiButton-textPrimary MuiButton-sizeMedium MuiButton-textSizeMedium MuiButtonBase-root  css-1e6y48t-MuiButtonBase-root-MuiButton-root"]')
